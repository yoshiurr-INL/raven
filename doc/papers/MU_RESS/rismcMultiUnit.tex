...
A summary of the chosen stochastic parameters are listed in Tables~\ref{tab:stochasticParameters} 
  ...
  \begin{center}
      \begin{tabular}{ | l | p{5cm} | c | p{5cm} |}
        \hline
         ...
         recovProcedTime    & Time to start plant recovery procedure    & hours        & Truncated normal (mean=1., sigma=.2, lower bound=.5, upper bound=1.5)       \\ \hline

...
\begin{figure}[!htbp]
	...
	\caption{Histogram of the ``best'' $k$ value for the PWR2 model when trained on 100 variations of size 2475 drawn from a pool of 4951 training samples. \DPM{Use other figure here where k=25 was better than k=15.}}
